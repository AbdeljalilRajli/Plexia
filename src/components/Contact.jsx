      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="text-center group animate-fadeInUp" style={{ animationDelay: '0.1s' }}>
            ...
            <h3 className="text-xl font-bold text-slate-100 mb-2 font-orbitron">Address</h3>
          ...
          <div className="text-center group animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
            ...
            <h3 className="text-xl font-bold text-slate-100 mb-2 font-orbitron">Phone</h3>
          ...
          <div className="text-center group animate-fadeInUp" style={{ animationDelay: '0.3s' }}>
            ...
            <h3 className="text-xl font-bold text-slate-100 mb-2 font-orbitron">Email</h3>
            <p className="text-slate-300">hello@plexia.com</p>
          </div>
        </div>
